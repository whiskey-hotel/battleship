...
class Gameboard {
  ...
  addShip(position, ship, length) {
    this.allShips.push(new _ships__WEBPACK_IMPORTED_MODULE_0__["default"](position, ship, length));
  }
...
/* harmony import */ var _modules_elementBuilder__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/elementBuilder */ "./src/modules/elementBuilder.js");




const main = _modules_elementBuilder__WEBPACK_IMPORTED_MODULE_2__.newElement({
  element: 'div',
  elementID: 'container',
});

const table = _modules_elementBuilder__WEBPACK_IMPORTED_MODULE_2__.newElement({
  element: 'div',
  elementID: 'table',
  className: 'container',
});
